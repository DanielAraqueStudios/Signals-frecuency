...
%   - firmware/part3_imu_sensor/            -> digitalización IMU (I2C), 200 Hz
...
%
% Ningún hardware físico (tarjeta STM32, osciloscopio, generador de
% señales, IMU, encoder/motoreductor) estuvo disponible en este entorno;
